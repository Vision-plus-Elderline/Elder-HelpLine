    ...
    <div className="space-y-8 bg-[#F7F9FC] rounded-md p-6">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight">
          Refresher <span className="text-teal-600">Training</span>
        </h1>
        <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
          The Refresher Training module is designed to provide a solid understanding of the basic principles of health and wellness. 
